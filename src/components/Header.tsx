      ...
      <div className="bg-primary text-primary-foreground py-2 px-4">
        <div className="container mx-auto flex justify-between items-center text-sm">
          <div className="flex items-center gap-4">
            <a 
              href="tel:8026220474" 
              className="flex items-center gap-1.5 hover:text-golden transition-colors"
            >
              <Phone className="w-3.5 h-3.5" />
              <span className="hidden sm:inline">(802) 622-0474</span>
            </a>
            <a 
            ...
            >
              ...
              <span className="hidden sm:inline">holli.daycare@gmail.com</span>
            </a>
          </div>
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2">
            ...
            <div>
              <span className="font-display text-xl font-bold text-foreground">Holli-Day</span>
              <span className="font-display text-xl font-bold text-primary"> Care</span>
            </div>
          </a>
          ...
          <div className="hidden lg:block">
            <Button variant="hero" size="lg" asChild>
              <a href="tel:8026220474">Schedule Meet & Greet</a>
            </Button>
          </div>
